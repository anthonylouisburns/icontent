...
# a config file.
# 
# - highlight2latex - ipython2python - strip_files_prefix - markdown2html -
# escape_latex - get_lines - ansi2html - comment_lines - markdown2latex -
# add_anchor - filter_data_type - prevent_list_blocks - add_prompts - strip_ansi
# - indent - posix_path - citation2latex - html2text - strip_dollars - path2url
# - markdown2rst - highlight2html - ansi2latex - wrap_text - ascii_only
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = {'image/png', 'image/svg+xml', 'image/jpeg', 'application/pdf'}
